...
export class GenerateChapters extends APIResource {
   ...
   */
  create(
    body: GenerateChapterCreateParams,
    options?: RequestOptions,
  ): APIPromise<GenerateChapterCreateResponse> {
    return (
      this._client.post('/robots/v1/jobs/generate-chapters', {
        body,
        defaultBaseURL: 'https://api.mux.com',
        ...options,
      }) as APIPromise<{ data: GenerateChapterCreateResponse }>
   ...
   * ```
   */
  retrieve(jobID: string, options?: RequestOptions): APIPromise<GenerateChapterRetrieveResponse> {
    return (
      this._client.get(path`/robots/v1/jobs/generate-chapters/${jobID}`, {
        defaultBaseURL: 'https://api.mux.com',
        ...options,
      }) as APIPromise<{ data: GenerateChapterRetrieveResponse }>
    )._thenUnwrap((obj) => obj.data);
  }
}

export interface GenerateChapterCreateResponse {
  /**
   ...
   */
  errors?: Array<GenerateChapterCreateResponse.Error>;

  /**
   * Workflow results. Present when status is 'completed'.
   */
  outputs?: GenerateChapterCreateResponse.Outputs;

  parameters?: GenerateChapterCreateResponse.Parameters;
...
export interface GenerateChapterRetrieveResponse {
  /**
   * Unique job identifier.
   */
  id: string;
   ...
   * Error details. Present when status is 'errored'.
   */
  errors?: Array<GenerateChapterRetrieveResponse.Error>;

  /**
   * Workflow results. Present when status is 'completed'.
   */
  outputs?: GenerateChapterRetrieveResponse.Outputs;

  parameters?: GenerateChapterRetrieveResponse.Parameters;
