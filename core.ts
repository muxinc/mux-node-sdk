...
import { getDefaultAgent } from 'mux/_shims/agent';
import { fetch, isPolyfilled as fetchIsPolyfilled } from 'mux/_shims/fetch';
import type { RequestInfo, RequestInit, Response } from 'mux/_shims/fetch';
import { isMultipartBody } from './uploads';
export { maybeMultipartFormRequestOptions, multipartFormRequestOptions, createForm } from './uploads';
export type { Uploadable } from 'mux/_shims/uploadable';
