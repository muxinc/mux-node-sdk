...
describe('resource playback', () => {
  test('animated: request options and params are passed correctly', async () => {
    ...
    await expect(client.video.playback.animated('PLAYBACK_ID', 'gif', {
    end: 0,
    fps: 0,
    height: 0,
    start: 0,
  ...
  test('hls: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.hls('PLAYBACK_ID', {
    asset_end_time: 0,
    asset_start_time: 0,
  ...
  test('staticRendition: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.staticRendition('PLAYBACK_ID', 'capped-1080p.mp4', { TOKEN: 'TOKEN' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Mux.NotFoundError);
  });
  ...
  test('storyboard: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.storyboard('PLAYBACK_ID', 'jpg', {
    asset_end_time: 0,
    asset_start_time: 0,
    program_end_time: 0,
    program_start_time: 0,
  ...
  test.skip('storyboardMeta: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.storyboardMeta('PLAYBACK_ID', {
    asset_end_time: 0,
    asset_start_time: 0,
    format: 'jpg',
    program_end_time: 0,
  ...
  test.skip('storyboardVtt: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.storyboardVtt('PLAYBACK_ID', {
    asset_end_time: 0,
    asset_start_time: 0,
    program_end_time: 0,
    program_start_time: 0,
  ...
  test('thumbnail: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.thumbnail('PLAYBACK_ID', 'jpg', {
    fit_mode: 'preserve',
    flip_h: true,
    flip_v: true,
    height: 0,
  ...
  test('track: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.track('PLAYBACK_ID', 'TRACK_ID', { TOKEN: 'TOKEN' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Mux.NotFoundError);
  });
  ...
  test('transcript: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.video.playback.transcript('PLAYBACK_ID', 'TRACK_ID', { TOKEN: 'TOKEN' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Mux.NotFoundError);
  });
});
