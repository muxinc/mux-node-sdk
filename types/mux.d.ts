...
export declare class LiveStreams extends Base {
    ...
    createPlaybackId(liveStreamId: string, params: CreatePlaybackIdParams): Promise<any>;
    deletePlaybackId(liveStreamId: string, playbackId: string): Promise<any>;
    createSimulcastTarget(liveStreamId: string, params: SimulcastTargetParams): Promise<any>
    getSimulcastTarget(liveStreamId: string, simulcastTargetId: string): Promise<any>;
