...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.Assets.List(context.TODO(), video.AssetListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tasset, err := client.Video.Assets.Get(context.TODO(), "ASSET_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", asset.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.Assets.Delete(context.TODO(), "ASSET_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/assets/$ASSET_ID \\\n    -X DELETE \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tasset, err := client.Video.Assets.Update(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\tvideo.AssetUpdateParams{\n\t\t\tPassthrough: mux.String("Example"),\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", asset.ID)\n}\n',
      },
      http: {
        example:
          "curl https://api.mux.com/video/v1/assets/$ASSET_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -u \"$MUX_TOKEN_ID:MUX_TOKEN_SECRET\" \\\n    -d '{}'",
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackId, err := client.Video.Assets.GetPlaybackId(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\t"PLAYBACK_ID",\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackId.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/shared"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackId, err := client.Video.Assets.NewPlaybackId(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\tvideo.AssetNewPlaybackIdParams{\n\t\t\tPolicy: shared.PlaybackPolicyPublic,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackId.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\ttrack, err := client.Video.Assets.NewTrack(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\tvideo.AssetNewTrackParams{\n\t\t\tLanguageCode:   "en-US",\n\t\t\tType:           video.AssetNewTrackParamsTypeText,\n\t\t\tURL:            "https://example.com/myVideo_en.srt",\n\t\t\tClosedCaptions: mux.Bool(true),\n\t\t\tName:           mux.String("English"),\n\t\t\tPassthrough:    mux.String("English"),\n\t\t\tTextType:       video.AssetNewTrackParamsTextTypeSubtitles,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", track.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.Assets.DeleteTrack(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\t"TRACK_ID",\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tinputInfos, err := client.Video.Assets.GetInputInfo(context.TODO(), "ASSET_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", inputInfos)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tasset, err := client.Video.Assets.UpdateMP4Support(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\tvideo.AssetUpdateMP4SupportParams{\n\t\t\tMP4Support: video.AssetUpdateMP4SupportParamsMP4SupportCapped1080p,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", asset.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tasset, err := client.Video.Assets.UpdateMasterAccess(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\tvideo.AssetUpdateMasterAccessParams{\n\t\t\tMasterAccess: video.AssetUpdateMasterAccessParamsMasterAccessTemporary,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", asset.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Assets.NewStaticRendition(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\tvideo.AssetNewStaticRenditionParams{\n\t\t\tResolution: video.AssetNewStaticRenditionParamsResolutionHighest,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.Assets.DeleteStaticRendition(\n\t\tcontext.TODO(),\n\t\t"ASSET_ID",\n\t\t"STATIC_RENDITION_ID",\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.DeliveryUsage.List(context.TODO(), video.DeliveryUsageListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/shared"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.New(context.TODO(), video.LiveStreamNewParams{\n\t\tNewAssetSettings: video.AssetOptionsParam{\n\t\t\tPlaybackPolicies: []shared.PlaybackPolicy{shared.PlaybackPolicyPublic},\n\t\t},\n\t\tPlaybackPolicies: []shared.PlaybackPolicy{shared.PlaybackPolicyPublic},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.LiveStreams.List(context.TODO(), video.LiveStreamListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.Get(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.LiveStreams.Delete(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/live-streams/$LIVE_STREAM_ID \\\n    -X DELETE \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.Update(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\tvideo.LiveStreamUpdateParams{\n\t\t\tLatencyMode:           video.LiveStreamUpdateParamsLatencyModeStandard,\n\t\t\tMaxContinuousDuration: mux.Int(1200),\n\t\t\tReconnectWindow:       mux.Float(30),\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
          "curl https://api.mux.com/video/v1/live-streams/$LIVE_STREAM_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -u \"$MUX_TOKEN_ID:MUX_TOKEN_SECRET\" \\\n    -d '{}'",
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/shared"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackId, err := client.Video.LiveStreams.NewPlaybackId(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\tvideo.LiveStreamNewPlaybackIdParams{\n\t\t\tPolicy: shared.PlaybackPolicySigned,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackId.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.ResetStreamKey(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.LiveStreams.Complete(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.LiveStreams.Disable(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.LiveStreams.Enable(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.UpdateEmbeddedSubtitles(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\tvideo.LiveStreamUpdateEmbeddedSubtitlesParams{\n\t\t\tEmbeddedSubtitles: []video.LiveStreamUpdateEmbeddedSubtitlesParamsEmbeddedSubtitle{{\n\t\t\t\tPassthrough: mux.String("Example"),\n\t\t\t}},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.UpdateGeneratedSubtitles(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\tvideo.LiveStreamUpdateGeneratedSubtitlesParams{\n\t\t\tGeneratedSubtitles: []video.LiveStreamUpdateGeneratedSubtitlesParamsGeneratedSubtitle{{\n\t\t\t\tName:         mux.String("English CC (ASR)"),\n\t\t\t\tLanguageCode: "en",\n\t\t\t\tPassthrough:  mux.String("Example"),\n\t\t\t}},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tsimulcastTarget, err := client.Video.LiveStreams.NewSimulcastTarget(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\tvideo.LiveStreamNewSimulcastTargetParams{\n\t\t\tURL:         "rtmp://live.example.com/app",\n\t\t\tPassthrough: mux.String("Example"),\n\t\t\tStreamKey:   mux.String("abcdefgh"),\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", simulcastTarget.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.LiveStreams.DeleteSimulcastTarget(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\t"SIMULCAST_TARGET_ID",\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tliveStream, err := client.Video.LiveStreams.UpdateNewAssetSettingsStaticRenditions(\n\t\tcontext.TODO(),\n\t\t"LIVE_STREAM_ID",\n\t\tvideo.LiveStreamUpdateNewAssetSettingsStaticRenditionsParams{\n\t\t\tStaticRenditions: []video.LiveStreamUpdateNewAssetSettingsStaticRenditionsParamsStaticRendition{{\n\t\t\t\tResolution: "audio-only",\n\t\t\t}, {\n\t\t\t\tResolution: "highest",\n\t\t\t}},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", liveStream.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.LiveStreams.DeleteNewAssetSettingsStaticRenditions(context.TODO(), "LIVE_STREAM_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/live-streams/$LIVE_STREAM_ID/new-asset-settings/static-renditions \\\n    -X DELETE \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackIds, err := client.Video.PlaybackIds.Get(context.TODO(), "PLAYBACK_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackIds.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackRestriction, err := client.Video.PlaybackRestrictions.New(context.TODO(), video.PlaybackRestrictionNewParams{\n\t\tReferrer: video.PlaybackRestrictionNewParamsReferrer{\n\t\t\tAllowedDomains:  []string{"*.example.com"},\n\t\t\tAllowNoReferrer: mux.Bool(true),\n\t\t},\n\t\tUserAgent: video.PlaybackRestrictionNewParamsUserAgent{\n\t\t\tAllowNoUserAgent:       mux.Bool(false),\n\t\t\tAllowHighRiskUserAgent: mux.Bool(false),\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackRestriction.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.PlaybackRestrictions.List(context.TODO(), video.PlaybackRestrictionListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/playback-restrictions \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.PlaybackRestrictions.Delete(context.TODO(), "PLAYBACK_RESTRICTION_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackRestriction, err := client.Video.PlaybackRestrictions.Get(context.TODO(), "PLAYBACK_RESTRICTION_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackRestriction.ID)\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/playback-restrictions/$PLAYBACK_RESTRICTION_ID \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackRestriction, err := client.Video.PlaybackRestrictions.UpdateReferrer(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_RESTRICTION_ID",\n\t\tvideo.PlaybackRestrictionUpdateReferrerParams{\n\t\t\tAllowedDomains:  []string{"*.example.com"},\n\t\t\tAllowNoReferrer: mux.Bool(true),\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackRestriction.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tplaybackRestriction, err := client.Video.PlaybackRestrictions.UpdateUserAgent(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_RESTRICTION_ID",\n\t\tvideo.PlaybackRestrictionUpdateUserAgentParams{\n\t\t\tAllowHighRiskUserAgent: false,\n\t\t\tAllowNoUserAgent:       false,\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", playbackRestriction.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\ttranscriptionVocabulary, err := client.Video.TranscriptionVocabularies.Get(context.TODO(), "TRANSCRIPTION_VOCABULARY_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", transcriptionVocabulary.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\ttranscriptionVocabulary, err := client.Video.TranscriptionVocabularies.New(context.TODO(), video.TranscriptionVocabularyNewParams{\n\t\tPhrases: []string{"Mux", "Live Stream", "Playback ID", "video encoding"},\n\t\tName:    mux.String("Mux API Vocabulary"),\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", transcriptionVocabulary.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Video.TranscriptionVocabularies.Delete(context.TODO(), "TRANSCRIPTION_VOCABULARY_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/transcription-vocabularies/$TRANSCRIPTION_VOCABULARY_ID \\\n    -X DELETE \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\ttranscriptionVocabulary, err := client.Video.TranscriptionVocabularies.Update(\n\t\tcontext.TODO(),\n\t\t"TRANSCRIPTION_VOCABULARY_ID",\n\t\tvideo.TranscriptionVocabularyUpdateParams{\n\t\t\tPhrases: []string{"Mux", "Live Stream", "RTMP", "Stream Key"},\n\t\t\tName:    mux.String("Mux API Vocabulary - Updated"),\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", transcriptionVocabulary.ID)\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/transcription-vocabularies/$TRANSCRIPTION_VOCABULARY_ID \\\n    -X PUT \\\n    -H \'Content-Type: application/json\' \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET" \\\n    -d \'{\n          "phrases": [\n            "Mux",\n            "Live Stream",\n            "RTMP",\n            "Stream Key"\n          ]\n        }\'',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.TranscriptionVocabularies.List(context.TODO(), video.TranscriptionVocabularyListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/video/v1/transcription-vocabularies \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    response:
      "{ id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: { message?: string; type?: string; }; new_asset_settings?: { advanced_playback_policies?: object[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: object[]; inputs?: object[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: object; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: playback_policy[]; playback_policy?: playback_policy[]; static_renditions?: object[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }; test?: boolean; url?: string; }",
    markdown:
      "## retrieve\n\n`client.video.uploads.retrieve(UPLOAD_ID: string): { id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: object; new_asset_settings?: asset_options; test?: boolean; url?: string; }`\n\n**get** `/video/v1/uploads/{UPLOAD_ID}`\n\nFetches information about a single direct upload in the current environment.\n\n### Parameters\n\n- `UPLOAD_ID: string`\n\n### Returns\n\n- `{ id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: { message?: string; type?: string; }; new_asset_settings?: { advanced_playback_policies?: object[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: object[]; inputs?: object[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: object; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: playback_policy[]; playback_policy?: playback_policy[]; static_renditions?: object[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }; test?: boolean; url?: string; }`\n\n  - `id: string`\n  - `cors_origin: string`\n  - `status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'`\n  - `timeout: number`\n  - `asset_id?: string`\n  - `error?: { message?: string; type?: string; }`\n  - `new_asset_settings?: { advanced_playback_policies?: { drm_configuration_id?: string; policy?: 'public' | 'signed' | 'drm'; }[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: { closed_captions?: boolean; end_time?: number; generated_subtitles?: { language_code?: string; name?: string; passthrough?: string; }[]; language_code?: string; name?: string; overlay_settings?: { height?: string; horizontal_align?: 'left' | 'center' | 'right'; horizontal_margin?: string; opacity?: string; vertical_align?: 'top' | 'middle' | 'bottom'; vertical_margin?: string; width?: string; }; passthrough?: string; start_time?: number; text_type?: 'subtitles'; type?: 'video' | 'audio' | 'text'; url?: string; }[]; inputs?: { closed_captions?: boolean; end_time?: number; generated_subtitles?: { language_code?: string; name?: string; passthrough?: string; }[]; language_code?: string; name?: string; overlay_settings?: { height?: string; horizontal_align?: 'left' | 'center' | 'right'; horizontal_margin?: string; opacity?: string; vertical_align?: 'top' | 'middle' | 'bottom'; vertical_margin?: string; width?: string; }; passthrough?: string; start_time?: number; text_type?: 'subtitles'; type?: 'video' | 'audio' | 'text'; url?: string; }[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: { creator_id?: string; external_id?: string; title?: string; }; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: 'public' | 'signed' | 'drm'[]; playback_policy?: 'public' | 'signed' | 'drm'[]; static_renditions?: { resolution: 'highest' | 'audio-only' | '2160p' | '1440p' | '1080p' | '720p' | '540p' | '480p' | '360p' | '270p'; passthrough?: string; }[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }`\n  - `test?: boolean`\n  - `url?: string`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst upload = await client.video.uploads.retrieve('abcd1234');\n\nconsole.log(upload);\n```",
    perLanguage: {
      go: {
        method: 'client.Video.Uploads.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tupload, err := client.Video.Uploads.Get(context.TODO(), "abcd1234")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", upload.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    response:
      "{ id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: { message?: string; type?: string; }; new_asset_settings?: { advanced_playback_policies?: object[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: object[]; inputs?: object[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: object; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: playback_policy[]; playback_policy?: playback_policy[]; static_renditions?: object[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }; test?: boolean; url?: string; }",
    markdown:
      "## cancel\n\n`client.video.uploads.cancel(UPLOAD_ID: string): { id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: object; new_asset_settings?: asset_options; test?: boolean; url?: string; }`\n\n**put** `/video/v1/uploads/{UPLOAD_ID}/cancel`\n\nCancels a direct upload and marks it as cancelled. If a pending upload finishes after this\nrequest, no asset will be created. This request will only succeed if the upload is still in\nthe `waiting` state.\n\n\n### Parameters\n\n- `UPLOAD_ID: string`\n\n### Returns\n\n- `{ id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: { message?: string; type?: string; }; new_asset_settings?: { advanced_playback_policies?: object[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: object[]; inputs?: object[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: object; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: playback_policy[]; playback_policy?: playback_policy[]; static_renditions?: object[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }; test?: boolean; url?: string; }`\n\n  - `id: string`\n  - `cors_origin: string`\n  - `status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'`\n  - `timeout: number`\n  - `asset_id?: string`\n  - `error?: { message?: string; type?: string; }`\n  - `new_asset_settings?: { advanced_playback_policies?: { drm_configuration_id?: string; policy?: 'public' | 'signed' | 'drm'; }[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: { closed_captions?: boolean; end_time?: number; generated_subtitles?: { language_code?: string; name?: string; passthrough?: string; }[]; language_code?: string; name?: string; overlay_settings?: { height?: string; horizontal_align?: 'left' | 'center' | 'right'; horizontal_margin?: string; opacity?: string; vertical_align?: 'top' | 'middle' | 'bottom'; vertical_margin?: string; width?: string; }; passthrough?: string; start_time?: number; text_type?: 'subtitles'; type?: 'video' | 'audio' | 'text'; url?: string; }[]; inputs?: { closed_captions?: boolean; end_time?: number; generated_subtitles?: { language_code?: string; name?: string; passthrough?: string; }[]; language_code?: string; name?: string; overlay_settings?: { height?: string; horizontal_align?: 'left' | 'center' | 'right'; horizontal_margin?: string; opacity?: string; vertical_align?: 'top' | 'middle' | 'bottom'; vertical_margin?: string; width?: string; }; passthrough?: string; start_time?: number; text_type?: 'subtitles'; type?: 'video' | 'audio' | 'text'; url?: string; }[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: { creator_id?: string; external_id?: string; title?: string; }; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: 'public' | 'signed' | 'drm'[]; playback_policy?: 'public' | 'signed' | 'drm'[]; static_renditions?: { resolution: 'highest' | 'audio-only' | '2160p' | '1440p' | '1080p' | '720p' | '540p' | '480p' | '360p' | '270p'; passthrough?: string; }[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }`\n  - `test?: boolean`\n  - `url?: string`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst upload = await client.video.uploads.cancel('abcd1234');\n\nconsole.log(upload);\n```",
    perLanguage: {
      go: {
        method: 'client.Video.Uploads.Cancel',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tupload, err := client.Video.Uploads.Cancel(context.TODO(), "abcd1234")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", upload.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    response:
      "{ id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: { message?: string; type?: string; }; new_asset_settings?: { advanced_playback_policies?: object[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: object[]; inputs?: object[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: object; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: playback_policy[]; playback_policy?: playback_policy[]; static_renditions?: object[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }; test?: boolean; url?: string; }",
    markdown:
      "## list\n\n`client.video.uploads.list(limit?: number, page?: number): { id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: object; new_asset_settings?: asset_options; test?: boolean; url?: string; }`\n\n**get** `/video/v1/uploads`\n\nLists direct uploads in the current environment.\n\n### Parameters\n\n- `limit?: number`\n  Number of items to include in the response\n\n- `page?: number`\n  Offset by this many pages, of the size of `limit`\n\n### Returns\n\n- `{ id: string; cors_origin: string; status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'; timeout: number; asset_id?: string; error?: { message?: string; type?: string; }; new_asset_settings?: { advanced_playback_policies?: object[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: object[]; inputs?: object[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: object; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: playback_policy[]; playback_policy?: playback_policy[]; static_renditions?: object[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }; test?: boolean; url?: string; }`\n\n  - `id: string`\n  - `cors_origin: string`\n  - `status: 'waiting' | 'asset_created' | 'errored' | 'cancelled' | 'timed_out'`\n  - `timeout: number`\n  - `asset_id?: string`\n  - `error?: { message?: string; type?: string; }`\n  - `new_asset_settings?: { advanced_playback_policies?: { drm_configuration_id?: string; policy?: 'public' | 'signed' | 'drm'; }[]; copy_overlays?: boolean; encoding_tier?: 'smart' | 'baseline' | 'premium'; input?: { closed_captions?: boolean; end_time?: number; generated_subtitles?: { language_code?: string; name?: string; passthrough?: string; }[]; language_code?: string; name?: string; overlay_settings?: { height?: string; horizontal_align?: 'left' | 'center' | 'right'; horizontal_margin?: string; opacity?: string; vertical_align?: 'top' | 'middle' | 'bottom'; vertical_margin?: string; width?: string; }; passthrough?: string; start_time?: number; text_type?: 'subtitles'; type?: 'video' | 'audio' | 'text'; url?: string; }[]; inputs?: { closed_captions?: boolean; end_time?: number; generated_subtitles?: { language_code?: string; name?: string; passthrough?: string; }[]; language_code?: string; name?: string; overlay_settings?: { height?: string; horizontal_align?: 'left' | 'center' | 'right'; horizontal_margin?: string; opacity?: string; vertical_align?: 'top' | 'middle' | 'bottom'; vertical_margin?: string; width?: string; }; passthrough?: string; start_time?: number; text_type?: 'subtitles'; type?: 'video' | 'audio' | 'text'; url?: string; }[]; master_access?: 'none' | 'temporary'; max_resolution_tier?: '1080p' | '1440p' | '2160p'; meta?: { creator_id?: string; external_id?: string; title?: string; }; mp4_support?: 'none' | 'standard' | 'capped-1080p' | 'audio-only' | 'audio-only,capped-1080p'; normalize_audio?: boolean; passthrough?: string; per_title_encode?: boolean; playback_policies?: 'public' | 'signed' | 'drm'[]; playback_policy?: 'public' | 'signed' | 'drm'[]; static_renditions?: { resolution: 'highest' | 'audio-only' | '2160p' | '1440p' | '1080p' | '720p' | '540p' | '480p' | '360p' | '270p'; passthrough?: string; }[]; test?: boolean; video_quality?: 'basic' | 'plus' | 'premium'; }`\n  - `test?: boolean`\n  - `url?: string`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\n// Automatically fetches more pages as needed.\nfor await (const upload of client.video.uploads.list()) {\n  console.log(upload);\n}\n```",
    perLanguage: {
      go: {
        method: 'client.Video.Uploads.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.Uploads.List(context.TODO(), video.UploadListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Video.DRMConfigurations.List(context.TODO(), video.DRMConfigurationListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tdrmConfiguration, err := client.Video.DRMConfigurations.Get(context.TODO(), "DRM_CONFIGURATION_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", drmConfiguration.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.Thumbnail(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackThumbnailParamsExtensionJpg,\n\t\tvideo.PlaybackThumbnailParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.Animated(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackAnimatedParamsExtensionGif,\n\t\tvideo.PlaybackAnimatedParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.Storyboard(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackStoryboardParamsExtensionJpg,\n\t\tvideo.PlaybackStoryboardParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.StoryboardVtt(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackStoryboardVttParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.StoryboardMeta(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackStoryboardMetaParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.Hls(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackHlsParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.StaticRendition(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\tvideo.PlaybackStaticRenditionParamsFilenameCapped1080pMP4,\n\t\tvideo.PlaybackStaticRenditionParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.Track(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\t"TRACK_ID",\n\t\tvideo.PlaybackTrackParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/video"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Video.Playback.Transcript(\n\t\tcontext.TODO(),\n\t\t"PLAYBACK_ID",\n\t\t"TRACK_ID",\n\t\tvideo.PlaybackTranscriptParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'list',
    endpoint: '/robots/v0/jobs',
    httpMethod: 'get',
    summary: 'List jobs',
    description:
      'Returns a paginated list of Robots jobs, with optional filters for workflow, status, and asset_id.',
    stainlessPath: '(resource) robots-preview.jobs > (method) list',
    qualified: 'client.robotsPreview.jobs.list',
    params: [
      'asset_id?: string;',
      'limit?: number;',
      'page?: number;',
    ...
    markdown:
      "## list\n\n`client.robotsPreview.jobs.list(asset_id?: string, limit?: number, page?: number, status?: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled', workflow?: string): { id: string; _links: object; created_at: number; status: job_status; updated_at: number; workflow: string; }`\n\n**get** `/robots/v0/jobs`\n\nReturns a paginated list of Robots jobs, with optional filters for workflow, status, and asset_id.\n\n### Parameters\n\n- `asset_id?: string`\n  Filter by Mux asset ID\n\n- `limit?: number`\n  Maximum number of jobs to return (default 25, max 100)\n\n- `page?: number`\n  Page number (default 1)\n\n- `status?: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  Filter by job status\n\n- `workflow?: string`\n  Filter by workflow name\n\n### Returns\n\n- `{ id: string; _links: { self: { href: string; }; }; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: string; }`\n\n  - `id: string`\n  - `_links: { self: { href: string; }; }`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: string`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\n// Automatically fetches more pages as needed.\nfor await (const jobSummary of client.robotsPreview.jobs.list()) {\n  console.log(jobSummary);\n}\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/robots-preview"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.RobotsPreview.Jobs.List(context.TODO(), robots-preview.JobListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  {
    name: 'cancel',
    endpoint: '/robots/v0/jobs/{JOB_ID}/cancel',
    httpMethod: 'post',
    summary: 'Cancel a job',
    description: 'Cancels a job that is currently pending or processing.',
    stainlessPath: '(resource) robots-preview.jobs > (method) cancel',
    qualified: 'client.robotsPreview.jobs.cancel',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; _links: { self: { href: string; }; }; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: string; }",
    markdown:
      "## cancel\n\n`client.robotsPreview.jobs.cancel(JOB_ID: string): { id: string; _links: object; created_at: number; status: job_status; updated_at: number; workflow: string; }`\n\n**post** `/robots/v0/jobs/{JOB_ID}/cancel`\n\nCancels a job that is currently pending or processing.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; _links: { self: { href: string; }; }; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: string; }`\n\n  - `id: string`\n  - `_links: { self: { href: string; }; }`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: string`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst jobSummary = await client.robotsPreview.jobs.cancel('rjob_lK9w2kI5J1');\n\nconsole.log(jobSummary);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.Cancel',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tjobSummary, err := client.RobotsPreview.Jobs.Cancel(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", jobSummary.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'create',
    endpoint: '/robots/v0/jobs/ask-questions',
    httpMethod: 'post',
    summary: "Create an 'ask-questions' job",
    description: 'Creates a new job that uses AI to answer questions about a Mux Video asset.',
    stainlessPath: '(resource) robots-preview.jobs.ask-questions > (method) create',
    qualified: 'client.robotsPreview.jobs.askQuestions.create',
    params: [
      'parameters: { asset_id: string; questions: { question: string; answer_options?: string[]; }[]; language_code?: string; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; questions: object[]; language_code?: string; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { answers: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## create\n\n`client.robotsPreview.jobs.askQuestions.create(parameters: { asset_id: string; questions: object[]; language_code?: string; }, passthrough?: string): { id: string; created_at: number; parameters: ask_questions_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'ask-questions'; errors?: job_error[]; outputs?: ask_questions_job_outputs; passthrough?: string; resources?: object; }`\n\n**post** `/robots/v0/jobs/ask-questions`\n\nCreates a new job that uses AI to answer questions about a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; questions: { question: string; answer_options?: string[]; }[]; language_code?: string; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to analyze.\n  - `questions: { question: string; answer_options?: string[]; }[]`\n    One or more questions to ask about the video. Each question can specify its own answer_options.\n  - `language_code?: string`\n    BCP 47 language code of the caption track to analyze (e.g. \"en\", \"fr\"). When omitted, the SDK uses the default track.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; questions: object[]; language_code?: string; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { answers: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; questions: { question: string; answer_options?: string[]; }[]; language_code?: string; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'ask-questions'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; skipped: boolean; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst askQuestionsJob = await client.robotsPreview.jobs.askQuestions.create({ parameters: { asset_id: 'mux_asset_123abc', questions: [{ question: 'How many people are speaking on camera?' }] } });\n\nconsole.log(askQuestionsJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.AskQuestions.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/robots-preview"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\taskQuestionsJob, err := client.RobotsPreview.Jobs.AskQuestions.New(context.TODO(), robots-preview.JobAskQuestionNewParams{\n\t\tParameters: robots - preview.AskQuestionsJobParameters{\n\t\t\tAssetId: "mux_asset_123abc",\n\t\t\tQuestions: []robots - preview.AskQuestionsJobParametersQuestion{robots - preview.AskQuestionsJobParametersQuestion{\n\t\t\t\tQuestion:      "How many people are speaking on camera?",\n\t\t\t\tAnswerOptions: []string{"one", "two", "three or more"},\n\t\t\t}},\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", askQuestionsJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'retrieve',
    endpoint: '/robots/v0/jobs/ask-questions/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get an 'ask-questions' job",
    description: "Retrieves the current status and results of an 'ask-questions' job.",
    stainlessPath: '(resource) robots-preview.jobs.ask-questions > (method) retrieve',
    qualified: 'client.robotsPreview.jobs.askQuestions.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; questions: object[]; language_code?: string; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { answers: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## retrieve\n\n`client.robotsPreview.jobs.askQuestions.retrieve(JOB_ID: string): { id: string; created_at: number; parameters: ask_questions_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'ask-questions'; errors?: job_error[]; outputs?: ask_questions_job_outputs; passthrough?: string; resources?: object; }`\n\n**get** `/robots/v0/jobs/ask-questions/{JOB_ID}`\n\nRetrieves the current status and results of an 'ask-questions' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; questions: object[]; language_code?: string; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { answers: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; questions: { question: string; answer_options?: string[]; }[]; language_code?: string; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'ask-questions'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; skipped: boolean; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst askQuestionsJob = await client.robotsPreview.jobs.askQuestions.retrieve('rjob_lK9w2kI5J1');\n\nconsole.log(askQuestionsJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.AskQuestions.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\taskQuestionsJob, err := client.RobotsPreview.Jobs.AskQuestions.Get(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", askQuestionsJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'create',
    endpoint: '/robots/v0/jobs/generate-chapters',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots-preview.jobs.generate-chapters > (method) create',
    qualified: 'client.robotsPreview.jobs.generateChapters.create',
    params: [
      'parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { chapters: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## create\n\n`client.robotsPreview.jobs.generateChapters.create(parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: object; }, passthrough?: string): { id: string; created_at: number; parameters: generate_chapters_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'generate-chapters'; errors?: job_error[]; outputs?: generate_chapters_job_outputs; passthrough?: string; resources?: object; }`\n\n**post** `/robots/v0/jobs/generate-chapters`\n\nCreates a new job that uses AI to generate chapters for a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to generate chapters for.\n  - `language_code?: string`\n    BCP 47 language code of the caption track to analyze (e.g. \"en\", \"fr\"). When omitted, the SDK prefers English if available.\n  - `output_language_code?: string`\n    BCP 47 language code for the output chapter titles. Auto-detected from the transcript if omitted.\n  - `prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }`\n    Override specific sections of the chapter generation prompt.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { chapters: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'generate-chapters'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { chapters: { start_time: number; title: string; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst generateChaptersJob = await client.robotsPreview.jobs.generateChapters.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(generateChaptersJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.GenerateChapters.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/robots-preview"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tgenerateChaptersJob, err := client.RobotsPreview.Jobs.GenerateChapters.New(context.TODO(), robots-preview.JobGenerateChapterNewParams{\n\t\tParameters: robots - preview.GenerateChaptersJobParameters{\n\t\t\tAssetId: "mux_asset_123abc",\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", generateChaptersJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'retrieve',
    endpoint: '/robots/v0/jobs/generate-chapters/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'generate-chapters' job",
    description: "Retrieves the current status and results of a 'generate-chapters' job.",
    stainlessPath: '(resource) robots-preview.jobs.generate-chapters > (method) retrieve',
    qualified: 'client.robotsPreview.jobs.generateChapters.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { chapters: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## retrieve\n\n`client.robotsPreview.jobs.generateChapters.retrieve(JOB_ID: string): { id: string; created_at: number; parameters: generate_chapters_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'generate-chapters'; errors?: job_error[]; outputs?: generate_chapters_job_outputs; passthrough?: string; resources?: object; }`\n\n**get** `/robots/v0/jobs/generate-chapters/{JOB_ID}`\n\nRetrieves the current status and results of a 'generate-chapters' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { chapters: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; language_code?: string; output_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'generate-chapters'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { chapters: { start_time: number; title: string; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst generateChaptersJob = await client.robotsPreview.jobs.generateChapters.retrieve('rjob_lK9w2kI5J1');\n\nconsole.log(generateChaptersJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.GenerateChapters.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tgenerateChaptersJob, err := client.RobotsPreview.Jobs.GenerateChapters.Get(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", generateChaptersJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'create',
    endpoint: '/robots/v0/jobs/find-key-moments',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots-preview.jobs.find-key-moments > (method) create',
    qualified: 'client.robotsPreview.jobs.findKeyMoments.create',
    params: [
      'parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; max_moments?: number; target_duration_ms?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { moments: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## create\n\n`client.robotsPreview.jobs.findKeyMoments.create(parameters: { asset_id: string; max_moments?: number; target_duration_ms?: object; }, passthrough?: string): { id: string; created_at: number; parameters: find_key_moments_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'find-key-moments'; errors?: job_error[]; outputs?: find_key_moments_job_outputs; passthrough?: string; resources?: object; }`\n\n**post** `/robots/v0/jobs/find-key-moments`\n\nCreates a new job that uses AI to identify key moments in a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to analyze.\n  - `max_moments?: number`\n    Maximum number of key moments to extract. Defaults to 5.\n  - `target_duration_ms?: { max: number; min: number; }`\n    Preferred highlight duration range in milliseconds. When provided, the model will aim to select moments within this range.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; max_moments?: number; target_duration_ms?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { moments: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'find-key-moments'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { moments: { audible_narrative: string; cues: { end_ms: number; start_ms: number; text: string; }[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: { concept: string; rationale: string; score: number; }[]; visual_narrative?: string; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst findKeyMomentsJob = await client.robotsPreview.jobs.findKeyMoments.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(findKeyMomentsJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.FindKeyMoments.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/robots-preview"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tfindKeyMomentsJob, err := client.RobotsPreview.Jobs.FindKeyMoments.New(context.TODO(), robots-preview.JobFindKeyMomentNewParams{\n\t\tParameters: robots - preview.FindKeyMomentsJobParameters{\n\t\t\tAssetId:    "mux_asset_123abc",\n\t\t\tMaxMoments: mux.Int(5),\n\t\t\tTargetDurationMs: robots - preview.FindKeyMomentsJobParametersTargetDurationMs{\n\t\t\t\tMin: 15000,\n\t\t\t\tMax: 45000,\n\t\t\t},\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", findKeyMomentsJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'retrieve',
    endpoint: '/robots/v0/jobs/find-key-moments/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'find-key-moments' job",
    description: "Retrieves the current status and results of a 'find-key-moments' job.",
    stainlessPath: '(resource) robots-preview.jobs.find-key-moments > (method) retrieve',
    qualified: 'client.robotsPreview.jobs.findKeyMoments.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; max_moments?: number; target_duration_ms?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { moments: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## retrieve\n\n`client.robotsPreview.jobs.findKeyMoments.retrieve(JOB_ID: string): { id: string; created_at: number; parameters: find_key_moments_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'find-key-moments'; errors?: job_error[]; outputs?: find_key_moments_job_outputs; passthrough?: string; resources?: object; }`\n\n**get** `/robots/v0/jobs/find-key-moments/{JOB_ID}`\n\nRetrieves the current status and results of a 'find-key-moments' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; max_moments?: number; target_duration_ms?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { moments: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'find-key-moments'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { moments: { audible_narrative: string; cues: { end_ms: number; start_ms: number; text: string; }[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: { concept: string; rationale: string; score: number; }[]; visual_narrative?: string; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst findKeyMomentsJob = await client.robotsPreview.jobs.findKeyMoments.retrieve('rjob_lK9w2kI5J1');\n\nconsole.log(findKeyMomentsJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.FindKeyMoments.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tfindKeyMomentsJob, err := client.RobotsPreview.Jobs.FindKeyMoments.Get(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", findKeyMomentsJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'create',
    endpoint: '/robots/v0/jobs/moderate',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots-preview.jobs.moderate > (method) create',
    qualified: 'client.robotsPreview.jobs.moderate.create',
    params: [
  ...
  {
    name: 'retrieve',
    endpoint: '/robots/v0/jobs/moderate/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'moderate' job",
    description: "Retrieves the current status and results of a 'moderate' job.",
    stainlessPath: '(resource) robots-preview.jobs.moderate > (method) retrieve',
    qualified: 'client.robotsPreview.jobs.moderate.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'moderate'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { exceeds_threshold: boolean; max_scores: object; thumbnail_scores: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## retrieve\n\n`client.robotsPreview.jobs.moderate.retrieve(JOB_ID: string): { id: string; created_at: number; parameters: moderate_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'moderate'; errors?: job_error[]; outputs?: moderate_job_outputs; passthrough?: string; resources?: object; }`\n\n**get** `/robots/v0/jobs/moderate/{JOB_ID}`\n\nRetrieves the current status and results of a 'moderate' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: object; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'moderate'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { exceeds_threshold: boolean; max_scores: object; thumbnail_scores: object[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'moderate'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; time?: number; }[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst moderateJob = await client.robotsPreview.jobs.moderate.retrieve('rjob_lK9w2kI5J1');\n\nconsole.log(moderateJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.Moderate.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tmoderateJob, err := client.RobotsPreview.Jobs.Moderate.Get(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", moderateJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'create',
    endpoint: '/robots/v0/jobs/summarize',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots-preview.jobs.summarize > (method) create',
    qualified: 'client.robotsPreview.jobs.summarize.create',
    params: [
      "parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; };",
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: object; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { description: string; tags: string[]; title: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## create\n\n`client.robotsPreview.jobs.summarize.create(parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: object; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }, passthrough?: string): { id: string; created_at: number; parameters: summarize_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'summarize'; errors?: job_error[]; outputs?: summarize_job_outputs; passthrough?: string; resources?: object; }`\n\n**post** `/robots/v0/jobs/summarize`\n\nCreates a new job that uses AI to generate a title, description, and tags for a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to summarize.\n  - `description_length?: number`\n    Maximum description length in words.\n  - `language_code?: string`\n    BCP 47 language code of the caption track to analyze (e.g. \"en\", \"fr\"). When omitted, the SDK uses the default track.\n  - `output_language_code?: string`\n    BCP 47 language code for the generated summary output (e.g. \"en\", \"fr\", \"ja\"). Auto-detected from the transcript if omitted.\n  - `prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }`\n    Override specific sections of the summarization prompt.\n  - `tag_count?: number`\n    Maximum number of tags to include in the generated output. Defaults to 10.\n  - `title_length?: number`\n    Maximum title length in words.\n  - `tone?: 'neutral' | 'playful' | 'professional'`\n    Tone for the generated summary. \"neutral\" for straightforward analysis, \"playful\" for witty and conversational, \"professional\" for executive-level reporting.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: object; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { description: string; tags: string[]; title: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'summarize'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { description: string; tags: string[]; title: string; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst summarizeJob = await client.robotsPreview.jobs.summarize.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(summarizeJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.Summarize.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/robots-preview"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tsummarizeJob, err := client.RobotsPreview.Jobs.Summarize.New(context.TODO(), robots-preview.JobSummarizeNewParams{\n\t\tParameters: robots - preview.SummarizeJobParameters{\n\t\t\tAssetId:  "mux_asset_123abc",\n\t\t\tTone:     robots - preview.SummarizeJobParametersToneNeutral,\n\t\t\tTagCount: mux.Int(10),\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", summarizeJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'retrieve',
    endpoint: '/robots/v0/jobs/summarize/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'summarize' job",
    description: "Retrieves the current status and results of a 'summarize' job.",
    stainlessPath: '(resource) robots-preview.jobs.summarize > (method) retrieve',
    qualified: 'client.robotsPreview.jobs.summarize.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: object; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { description: string; tags: string[]; title: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## retrieve\n\n`client.robotsPreview.jobs.summarize.retrieve(JOB_ID: string): { id: string; created_at: number; parameters: summarize_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'summarize'; errors?: job_error[]; outputs?: summarize_job_outputs; passthrough?: string; resources?: object; }`\n\n**get** `/robots/v0/jobs/summarize/{JOB_ID}`\n\nRetrieves the current status and results of a 'summarize' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: object; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { description: string; tags: string[]; title: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; description_length?: number; language_code?: string; output_language_code?: string; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'summarize'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { description: string; tags: string[]; title: string; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst summarizeJob = await client.robotsPreview.jobs.summarize.retrieve('rjob_lK9w2kI5J1');\n\nconsole.log(summarizeJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.Summarize.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tsummarizeJob, err := client.RobotsPreview.Jobs.Summarize.Get(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", summarizeJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'create',
    endpoint: '/robots/v0/jobs/translate-captions',
    httpMethod: 'post',
    summary: "Create a 'translate-captions' job",
    description:
      'Creates a new job that translates captions on a Mux Video asset from one language to another.',
    stainlessPath: '(resource) robots-preview.jobs.translate-captions > (method) create',
    qualified: 'client.robotsPreview.jobs.translateCaptions.create',
    params: [
      'parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { temporary_vtt_url?: string; track_id?: string; uploaded_track_id?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## create\n\n`client.robotsPreview.jobs.translateCaptions.create(parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }, passthrough?: string): { id: string; created_at: number; parameters: translate_captions_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'translate-captions'; errors?: job_error[]; outputs?: translate_captions_job_outputs; passthrough?: string; resources?: object; }`\n\n**post** `/robots/v0/jobs/translate-captions`\n\nCreates a new job that translates captions on a Mux Video asset from one language to another.\n\n### Parameters\n\n- `parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }`\n  - `asset_id: string`\n    The Mux asset ID of the video whose captions will be translated.\n  - `to_language_code: string`\n    BCP 47 language code for the translated output (e.g. \"es\", \"ja\"). The asset must not already have a text track for this language.\n  - `track_id: string`\n    The Mux text track ID of the source caption track to translate. The asset must have a ready text track matching this ID or the request will be rejected.\n  - `upload_to_mux?: boolean`\n    Whether to upload the translated VTT and attach it as a text track on the Mux asset. Defaults to true.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { temporary_vtt_url?: string; track_id?: string; uploaded_track_id?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'translate-captions'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { temporary_vtt_url?: string; track_id?: string; uploaded_track_id?: string; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst translateCaptionsJob = await client.robotsPreview.jobs.translateCaptions.create({ parameters: {\n  asset_id: 'mux_asset_123abc',\n  to_language_code: 'es',\n  track_id: 'track_en_abc123',\n} });\n\nconsole.log(translateCaptionsJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.TranslateCaptions.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n\t"github.com/stainless-sdks/mux-go/robots-preview"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\ttranslateCaptionsJob, err := client.RobotsPreview.Jobs.TranslateCaptions.New(context.TODO(), robots-preview.JobTranslateCaptionNewParams{\n\t\tParameters: robots - preview.TranslateCaptionsJobParameters{\n\t\t\tAssetId:        "mux_asset_123abc",\n\t\t\tTrackId:        "track_en_abc123",\n\t\t\tToLanguageCode: "es",\n\t\t\tUploadToMux:    mux.Bool(true),\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", translateCaptionsJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  {
    name: 'retrieve',
    endpoint: '/robots/v0/jobs/translate-captions/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'translate-captions' job",
    description: "Retrieves the current status and results of a 'translate-captions' job.",
    stainlessPath: '(resource) robots-preview.jobs.translate-captions > (method) retrieve',
    qualified: 'client.robotsPreview.jobs.translateCaptions.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { temporary_vtt_url?: string; track_id?: string; uploaded_track_id?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }",
    markdown:
      "## retrieve\n\n`client.robotsPreview.jobs.translateCaptions.retrieve(JOB_ID: string): { id: string; created_at: number; parameters: translate_captions_job_parameters; status: job_status; units_consumed: number; updated_at: number; workflow: 'translate-captions'; errors?: job_error[]; outputs?: translate_captions_job_outputs; passthrough?: string; resources?: object; }`\n\n**get** `/robots/v0/jobs/translate-captions/{JOB_ID}`\n\nRetrieves the current status and results of a 'translate-captions' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; units_consumed: number; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; retryable?: boolean; }[]; outputs?: { temporary_vtt_url?: string; track_id?: string; uploaded_track_id?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `parameters: { asset_id: string; to_language_code: string; track_id: string; upload_to_mux?: boolean; }`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `units_consumed: number`\n  - `updated_at: number`\n  - `workflow: 'translate-captions'`\n  - `errors?: { message: string; type: string; retryable?: boolean; }[]`\n  - `outputs?: { temporary_vtt_url?: string; track_id?: string; uploaded_track_id?: string; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst translateCaptionsJob = await client.robotsPreview.jobs.translateCaptions.retrieve('rjob_lK9w2kI5J1');\n\nconsole.log(translateCaptionsJob);\n```",
    perLanguage: {
      go: {
        method: 'client.RobotsPreview.Jobs.TranslateCaptions.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\ttranslateCaptionsJob, err := client.RobotsPreview.Jobs.TranslateCaptions.Get(context.TODO(), "rjob_lK9w2kI5J1")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", translateCaptionsJob.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tdimensionsResponse, err := client.Data.Dimensions.List(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", dimensionsResponse.Data)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Dimensions.ListValues(\n\t\tcontext.TODO(),\n\t\t"abcd1234",\n\t\tdata.DimensionListValuesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Dimensions.ListTraceElements(\n\t\tcontext.TODO(),\n\t\t"abcd1234",\n\t\tdata.DimensionListTraceElementsParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Data.Monitoring.ListDimensions(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tmetrics, err := client.Data.Monitoring.Metrics.List(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", metrics.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Data.Monitoring.Metrics.GetBreakdown(\n\t\tcontext.TODO(),\n\t\tdata.MonitoringMetricGetBreakdownParamsMonitoringMetricIDCurrentConcurrentViewers,\n\t\tdata.MonitoringMetricGetBreakdownParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Data.Monitoring.Metrics.GetTimeseries(\n\t\tcontext.TODO(),\n\t\tdata.MonitoringMetricGetTimeseriesParamsMonitoringMetricIDCurrentConcurrentViewers,\n\t\tdata.MonitoringMetricGetTimeseriesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Data.Monitoring.Metrics.GetBreakdownTimeseries(\n\t\tcontext.TODO(),\n\t\tdata.MonitoringMetricGetBreakdownTimeseriesParamsMonitoringMetricIDCurrentConcurrentViewers,\n\t\tdata.MonitoringMetricGetBreakdownTimeseriesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.Data.Monitoring.Metrics.GetHistogramTimeseries(\n\t\tcontext.TODO(),\n\t\tdata.MonitoringMetricGetHistogramTimeseriesParamsMonitoringHistogramMetricIDVideoStartupTime,\n\t\tdata.MonitoringMetricGetHistogramTimeseriesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terrorsResponse, err := client.Data.Errors.List(context.TODO(), data.ErrorListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", errorsResponse.Data)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tvideoViewExportsResponse, err := client.Data.Exports.ListVideoViews(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", videoViewExportsResponse.Data)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Filters.ListValues(\n\t\tcontext.TODO(),\n\t\t"abcd1234",\n\t\tdata.FilterListValuesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tincidentResponse, err := client.Data.Incidents.Get(context.TODO(), "abcd1234")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", incidentResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Incidents.ListRelated(\n\t\tcontext.TODO(),\n\t\t"abcd1234",\n\t\tdata.IncidentListRelatedParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Incidents.List(context.TODO(), data.IncidentListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tallMetricValuesResponse, err := client.Data.Metrics.List(context.TODO(), data.MetricListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", allMetricValuesResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Metrics.ListBreakdownValues(\n\t\tcontext.TODO(),\n\t\tdata.MetricListBreakdownValuesParamsMetricIDVideoStartupTime,\n\t\tdata.MetricListBreakdownValuesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\toverallValuesResponse, err := client.Data.Metrics.GetOverallValues(\n\t\tcontext.TODO(),\n\t\tdata.MetricGetOverallValuesParamsMetricIDVideoStartupTime,\n\t\tdata.MetricGetOverallValuesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", overallValuesResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tinsightsResponse, err := client.Data.Metrics.GetInsights(\n\t\tcontext.TODO(),\n\t\tdata.MetricGetInsightsParamsMetricIDVideoStartupTime,\n\t\tdata.MetricGetInsightsParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", insightsResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tmetricTimeseriesDataResponse, err := client.Data.Metrics.GetTimeseries(\n\t\tcontext.TODO(),\n\t\tdata.MetricGetTimeseriesParamsMetricIDVideoStartupTime,\n\t\tdata.MetricGetTimeseriesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", metricTimeseriesDataResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\trealTimeBreakdownResponse, err := client.Data.RealTime.GetBreakdown(\n\t\tcontext.TODO(),\n\t\tdata.RealTimeGetBreakdownParamsRealtimeMetricIDCurrentConcurrentViewers,\n\t\tdata.RealTimeGetBreakdownParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", realTimeBreakdownResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\trealTimeTimeseriesResponse, err := client.Data.RealTime.GetTimeseries(\n\t\tcontext.TODO(),\n\t\tdata.RealTimeGetTimeseriesParamsRealtimeMetricIDCurrentConcurrentViewers,\n\t\tdata.RealTimeGetTimeseriesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", realTimeTimeseriesResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\trealTimeMetricsResponse, err := client.Data.RealTime.ListMetrics(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", realTimeMetricsResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\trealTimeHistogramTimeseriesResponse, err := client.Data.RealTime.GetHistogramTimeseries(\n\t\tcontext.TODO(),\n\t\tdata.RealTimeGetHistogramTimeseriesParamsRealtimeHistogramMetricIDVideoStartupTime,\n\t\tdata.RealTimeGetHistogramTimeseriesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", realTimeHistogramTimeseriesResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\trealTimeDimensionsResponse, err := client.Data.RealTime.ListDimensions(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", realTimeDimensionsResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.VideoViews.List(context.TODO(), data.VideoViewListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tvideoViewResponse, err := client.Data.VideoViews.Get(context.TODO(), "abcd1234")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", videoViewResponse.Data)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.Data.Annotations.List(context.TODO(), data.AnnotationListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tannotation, err := client.Data.Annotations.Get(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", annotation.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tannotation, err := client.Data.Annotations.New(context.TODO(), data.AnnotationNewParams{\n\t\tAnnotationInput: data.AnnotationInputParam{\n\t\t\tDate: 1745438400,\n\t\t\tNote: "This is a note",\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", annotation.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.Data.Annotations.Delete(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/data/v1/annotations/$ANNOTATION_ID \\\n    -X DELETE \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/data"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tannotation, err := client.Data.Annotations.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tdata.AnnotationUpdateParams{\n\t\t\tAnnotationInput: data.AnnotationInputParam{\n\t\t\t\tDate: 1745438400,\n\t\t\t\tNote: "This is a note",\n\t\t\t},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", annotation.ID)\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/data/v1/annotations/$ANNOTATION_ID \\\n    -X PATCH \\\n    -H \'Content-Type: application/json\' \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET" \\\n    -d \'{\n          "date": 1745438400,\n          "note": "This is a note"\n        }\'',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tsigningKey, err := client.System.SigningKeys.New(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", signingKey.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tpage, err := client.System.SigningKeys.List(context.TODO(), mux.SystemSigningKeyListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/system/v1/signing-keys \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tsigningKey, err := client.System.SigningKeys.Get(context.TODO(), "SIGNING_KEY_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", signingKey.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\terr := client.System.SigningKeys.Delete(context.TODO(), "SIGNING_KEY_ID")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://api.mux.com/system/v1/signing-keys/$SIGNING_KEY_ID \\\n    -X DELETE \\\n    -u "$MUX_TOKEN_ID:MUX_TOKEN_SECRET"',
  ...
  },
  {
    ...
    perLanguage: {
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/mux-go"\n\t"github.com/stainless-sdks/mux-go/muxoption"\n)\n\nfunc main() {\n\tclient := mux.NewClient(\n\t\tmuxoption.WithTokenId("my token id"),\n\t\tmuxoption.WithTokenSecret("my secret"),\n\t)\n\tresponse, err := client.System.Utilities.Whoami(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.EnvironmentID)\n}\n',
      },
      http: {
