...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  {
    name: 'list',
    endpoint: '/robots/v1/jobs',
    httpMethod: 'get',
    summary: 'List jobs',
    description:
      'Returns a paginated list of Robots jobs, with optional filters for workflow, status, and asset_id.',
    stainlessPath: '(resource) robots.jobs > (method) list',
    qualified: 'client.robots.jobs.list',
    params: [
      'asset_id?: string;',
      'limit?: number;',
      'page?: number;',
    ...
    markdown:
      "## list\n\n`client.robots.jobs.list(asset_id?: string, limit?: number, page?: number, status?: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled', workflow?: string): { id: string; _links: object; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: string; }`\n\n**get** `/robots/v1/jobs`\n\nReturns a paginated list of Robots jobs, with optional filters for workflow, status, and asset_id.\n\n### Parameters\n\n- `asset_id?: string`\n  Filter by Mux asset ID\n\n- `limit?: number`\n  Maximum number of jobs to return (default 25, max 100)\n\n- `page?: number`\n  Page number (default 1)\n\n- `status?: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  Filter by job status\n\n- `workflow?: string`\n  Filter by workflow name\n\n### Returns\n\n- `{ id: string; _links: { self: { href: string; }; }; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: string; }`\n\n  - `id: string`\n  - `_links: { self: { href: string; }; }`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: string`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\n// Automatically fetches more pages as needed.\nfor await (const jobListResponse of client.robots.jobs.list()) {\n  console.log(jobListResponse);\n}\n```",
  },
  {
    name: 'delete',
    endpoint: '/robots/v1/jobs/{JOB_ID}',
    httpMethod: 'delete',
    summary: 'Delete a job',
    description: 'Permanently deletes a job and its associated data.',
    stainlessPath: '(resource) robots.jobs > (method) delete',
  ...
  {
    name: 'cancel',
    endpoint: '/robots/v1/jobs/{JOB_ID}/cancel',
    httpMethod: 'post',
  ...
  {
    name: 'create',
    endpoint: '/robots/v1/jobs/ask-questions',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots.jobs.ask-questions > (method) create',
    qualified: 'client.robots.jobs.askQuestions.create',
    params: [
      'parameters: { asset_id: string; questions: { question: string; }[]; answer_options?: string[]; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; }[]; outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; }[]; }; parameters?: { asset_ids: string[]; questions: { question: string; }[]; answer_options?: string[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## create\n\n`client.robots.jobs.askQuestions.create(parameters: { asset_id: string; questions: { question: string; }[]; answer_options?: string[]; }, passthrough?: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'ask-questions'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**post** `/robots/v1/jobs/ask-questions`\n\nCreates a new job that uses AI to answer questions about a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; questions: { question: string; }[]; answer_options?: string[]; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to analyze.\n  - `questions: { question: string; }[]`\n    One or more questions to ask about the video. All questions are evaluated in a single AI call for efficiency.\n  - `answer_options?: string[]`\n    Allowed answer values the AI must choose from. Defaults to [\"yes\", \"no\"] if not provided. Can be customized to any set of options, e.g. [\"high\", \"medium\", \"low\"].\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; }[]; outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; }[]; }; parameters?: { asset_ids: string[]; questions: { question: string; }[]; answer_options?: string[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'ask-questions'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; }[]; }`\n  - `parameters?: { asset_ids: string[]; questions: { question: string; }[]; answer_options?: string[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst askQuestion = await client.robots.jobs.askQuestions.create({ parameters: { asset_id: 'mux_asset_123abc', questions: [{ question: 'Is there a person speaking on camera?' }] } });\n\nconsole.log(askQuestion);\n```",
  },
  {
    name: 'retrieve',
    endpoint: '/robots/v1/jobs/ask-questions/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get an 'ask-questions' job",
    description: "Retrieves the current status and results of an 'ask-questions' job.",
    stainlessPath: '(resource) robots.jobs.ask-questions > (method) retrieve',
    qualified: 'client.robots.jobs.askQuestions.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; }[]; outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; }[]; }; parameters?: { asset_ids: string[]; questions: { question: string; }[]; answer_options?: string[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## retrieve\n\n`client.robots.jobs.askQuestions.retrieve(JOB_ID: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'ask-questions'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**get** `/robots/v1/jobs/ask-questions/{JOB_ID}`\n\nRetrieves the current status and results of an 'ask-questions' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'ask-questions'; errors?: { message: string; type: string; }[]; outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; }[]; }; parameters?: { asset_ids: string[]; questions: { question: string; }[]; answer_options?: string[]; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'ask-questions'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { answers: { answer: string; confidence: number; question: string; reasoning: string; }[]; }`\n  - `parameters?: { asset_ids: string[]; questions: { question: string; }[]; answer_options?: string[]; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst askQuestion = await client.robots.jobs.askQuestions.retrieve('rjob_E6fdcD7d-cDdf-baAa-b31A-1ae5A92d336F');\n\nconsole.log(askQuestion);\n```",
  },
  {
    name: 'create',
    endpoint: '/robots/v1/jobs/generate-chapters',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots.jobs.generate-chapters > (method) create',
    qualified: 'client.robots.jobs.generateChapters.create',
    params: [
    ...
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; }[]; outputs?: { chapters: { start_time: number; title: string; }[]; }; parameters?: { asset_ids: string[]; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## create\n\n`client.robots.jobs.generateChapters.create(parameters: { asset_id: string; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }, passthrough?: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'generate-chapters'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**post** `/robots/v1/jobs/generate-chapters`\n\nCreates a new job that uses AI to generate chapters for a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to generate chapters for.\n  - `from_language_code?: string`\n    BCP 47 language code of the caption track to analyze. Defaults to \"en\".\n  - `prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }`\n    Override specific sections of the chapter generation prompt.\n  - `to_language_code?: string`\n    BCP 47 language code for the output chapter titles. Auto-detected from the transcript if omitted.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; }[]; outputs?: { chapters: { start_time: number; title: string; }[]; }; parameters?: { asset_ids: string[]; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'generate-chapters'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { chapters: { start_time: number; title: string; }[]; }`\n  - `parameters?: { asset_ids: string[]; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst generateChapter = await client.robots.jobs.generateChapters.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(generateChapter);\n```",
  },
  {
    name: 'retrieve',
    endpoint: '/robots/v1/jobs/generate-chapters/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'generate-chapters' job",
    description: "Retrieves the current status and results of a 'generate-chapters' job.",
    stainlessPath: '(resource) robots.jobs.generate-chapters > (method) retrieve',
    qualified: 'client.robots.jobs.generateChapters.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; }[]; outputs?: { chapters: { start_time: number; title: string; }[]; }; parameters?: { asset_ids: string[]; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## retrieve\n\n`client.robots.jobs.generateChapters.retrieve(JOB_ID: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'generate-chapters'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**get** `/robots/v1/jobs/generate-chapters/{JOB_ID}`\n\nRetrieves the current status and results of a 'generate-chapters' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'generate-chapters'; errors?: { message: string; type: string; }[]; outputs?: { chapters: { start_time: number; title: string; }[]; }; parameters?: { asset_ids: string[]; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'generate-chapters'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { chapters: { start_time: number; title: string; }[]; }`\n  - `parameters?: { asset_ids: string[]; from_language_code?: string; prompt_overrides?: { chapter_guidelines?: string; output_format?: string; task?: string; title_guidelines?: string; }; to_language_code?: string; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst generateChapter = await client.robots.jobs.generateChapters.retrieve('rjob_E6fdcD7d-cDdf-baAa-b31A-1ae5A92d336F');\n\nconsole.log(generateChapter);\n```",
  },
  {
    name: 'create',
    endpoint: '/robots/v1/jobs/find-key-moments',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots.jobs.find-key-moments > (method) create',
    qualified: 'client.robots.jobs.findKeyMoments.create',
    params: [
      'parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; }[]; outputs?: { moments: { audible_narrative: string; cues: object[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: object[]; visual_narrative?: string; }[]; }; parameters?: { asset_ids: string[]; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## create\n\n`client.robots.jobs.findKeyMoments.create(parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }, passthrough?: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'find-key-moments'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**post** `/robots/v1/jobs/find-key-moments`\n\nCreates a new job that uses AI to identify key moments in a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to analyze.\n  - `max_moments?: number`\n    Maximum number of key moments to extract. Defaults to 5.\n  - `target_duration_ms?: { max: number; min: number; }`\n    Preferred highlight duration range in milliseconds. When provided, the model will aim to select moments within this range.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; }[]; outputs?: { moments: { audible_narrative: string; cues: object[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: object[]; visual_narrative?: string; }[]; }; parameters?: { asset_ids: string[]; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'find-key-moments'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { moments: { audible_narrative: string; cues: { end_ms: number; start_ms: number; text: string; }[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: { concept: string; rationale: string; score: number; }[]; visual_narrative?: string; }[]; }`\n  - `parameters?: { asset_ids: string[]; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst findKeyMoment = await client.robots.jobs.findKeyMoments.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(findKeyMoment);\n```",
  },
  {
    name: 'retrieve',
    endpoint: '/robots/v1/jobs/find-key-moments/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'find-key-moments' job",
    description: "Retrieves the current status and results of a 'find-key-moments' job.",
    stainlessPath: '(resource) robots.jobs.find-key-moments > (method) retrieve',
    qualified: 'client.robots.jobs.findKeyMoments.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; }[]; outputs?: { moments: { audible_narrative: string; cues: object[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: object[]; visual_narrative?: string; }[]; }; parameters?: { asset_ids: string[]; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## retrieve\n\n`client.robots.jobs.findKeyMoments.retrieve(JOB_ID: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'find-key-moments'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**get** `/robots/v1/jobs/find-key-moments/{JOB_ID}`\n\nRetrieves the current status and results of a 'find-key-moments' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'find-key-moments'; errors?: { message: string; type: string; }[]; outputs?: { moments: { audible_narrative: string; cues: object[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: object[]; visual_narrative?: string; }[]; }; parameters?: { asset_ids: string[]; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'find-key-moments'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { moments: { audible_narrative: string; cues: { end_ms: number; start_ms: number; text: string; }[]; end_ms: number; notable_audible_concepts: string[]; overall_score: number; start_ms: number; title: string; notable_visual_concepts?: { concept: string; rationale: string; score: number; }[]; visual_narrative?: string; }[]; }`\n  - `parameters?: { asset_ids: string[]; max_moments?: number; target_duration_ms?: { max: number; min: number; }; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst findKeyMoment = await client.robots.jobs.findKeyMoments.retrieve('rjob_E6fdcD7d-cDdf-baAa-b31A-1ae5A92d336F');\n\nconsole.log(findKeyMoment);\n```",
  },
  {
    name: 'create',
    endpoint: '/robots/v1/jobs/moderate',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots.jobs.moderate > (method) create',
    qualified: 'client.robots.jobs.moderate.create',
    params: [
    ...
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'moderate'; errors?: { message: string; type: string; }[]; outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; }[]; }; parameters?: { asset_ids: string[]; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## create\n\n`client.robots.jobs.moderate.create(parameters: { asset_id: string; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }, passthrough?: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'moderate'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**post** `/robots/v1/jobs/moderate`\n\nCreates a new job that uses AI to analyze a Mux Video asset for inappropriate content.\n\n### Parameters\n\n- `parameters: { asset_id: string; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to moderate.\n  - `language_code?: string`\n    Language code for transcript analysis on audio-only assets. Defaults to \"en\".\n  - `max_samples?: number`\n    Maximum number of thumbnails to sample. When set, samples are distributed evenly across the video with the first and last frames pinned.\n  - `sampling_interval?: number`\n    Interval in seconds between sampled thumbnails. Minimum 5.\n  - `thresholds?: { sexual?: number; violence?: number; }`\n    Score thresholds that determine whether content is flagged. Defaults to {sexual: 0.7, violence: 0.8}.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'moderate'; errors?: { message: string; type: string; }[]; outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; }[]; }; parameters?: { asset_ids: string[]; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'moderate'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; }[]; }`\n  - `parameters?: { asset_ids: string[]; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst moderate = await client.robots.jobs.moderate.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(moderate);\n```",
  },
  {
    name: 'retrieve',
    endpoint: '/robots/v1/jobs/moderate/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'moderate' job",
    description: "Retrieves the current status and results of a 'moderate' job.",
    stainlessPath: '(resource) robots.jobs.moderate > (method) retrieve',
    qualified: 'client.robots.jobs.moderate.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'moderate'; errors?: { message: string; type: string; }[]; outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; }[]; }; parameters?: { asset_ids: string[]; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## retrieve\n\n`client.robots.jobs.moderate.retrieve(JOB_ID: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'moderate'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**get** `/robots/v1/jobs/moderate/{JOB_ID}`\n\nRetrieves the current status and results of a 'moderate' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'moderate'; errors?: { message: string; type: string; }[]; outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; }[]; }; parameters?: { asset_ids: string[]; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'moderate'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { exceeds_threshold: boolean; max_scores: { sexual: number; violence: number; }; thumbnail_scores: { sexual: number; violence: number; }[]; }`\n  - `parameters?: { asset_ids: string[]; language_code?: string; max_samples?: number; sampling_interval?: number; thresholds?: { sexual?: number; violence?: number; }; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst moderate = await client.robots.jobs.moderate.retrieve('rjob_E6fdcD7d-cDdf-baAa-b31A-1ae5A92d336F');\n\nconsole.log(moderate);\n```",
  },
  {
    name: 'create',
    endpoint: '/robots/v1/jobs/summarize',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots.jobs.summarize > (method) create',
    qualified: 'client.robots.jobs.summarize.create',
    params: [
    ...
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; }[]; outputs?: { description: string; tags: string[]; title: string; }; parameters?: { asset_ids: string[]; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## create\n\n`client.robots.jobs.summarize.create(parameters: { asset_id: string; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }, passthrough?: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'summarize'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**post** `/robots/v1/jobs/summarize`\n\nCreates a new job that uses AI to generate a title, description, and tags for a Mux Video asset.\n\n### Parameters\n\n- `parameters: { asset_id: string; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }`\n  - `asset_id: string`\n    The Mux asset ID of the video to summarize.\n  - `description_length?: number`\n    Desired description length in characters.\n  - `prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }`\n    Override specific sections of the summarization prompt.\n  - `tag_count?: number`\n    Desired number of tags to generate. Defaults to 10.\n  - `title_length?: number`\n    Desired title length in characters.\n  - `tone?: 'neutral' | 'playful' | 'professional'`\n    Tone for the generated summary. \"neutral\" for straightforward analysis, \"playful\" for witty and conversational, \"professional\" for executive-level reporting.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; }[]; outputs?: { description: string; tags: string[]; title: string; }; parameters?: { asset_ids: string[]; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'summarize'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { description: string; tags: string[]; title: string; }`\n  - `parameters?: { asset_ids: string[]; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst summarize = await client.robots.jobs.summarize.create({ parameters: { asset_id: 'mux_asset_123abc' } });\n\nconsole.log(summarize);\n```",
  },
  {
    name: 'retrieve',
    endpoint: '/robots/v1/jobs/summarize/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'summarize' job",
    description: "Retrieves the current status and results of a 'summarize' job.",
    stainlessPath: '(resource) robots.jobs.summarize > (method) retrieve',
    qualified: 'client.robots.jobs.summarize.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; }[]; outputs?: { description: string; tags: string[]; title: string; }; parameters?: { asset_ids: string[]; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## retrieve\n\n`client.robots.jobs.summarize.retrieve(JOB_ID: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'summarize'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**get** `/robots/v1/jobs/summarize/{JOB_ID}`\n\nRetrieves the current status and results of a 'summarize' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'summarize'; errors?: { message: string; type: string; }[]; outputs?: { description: string; tags: string[]; title: string; }; parameters?: { asset_ids: string[]; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'summarize'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { description: string; tags: string[]; title: string; }`\n  - `parameters?: { asset_ids: string[]; description_length?: number; prompt_overrides?: { description?: string; keywords?: string; quality_guidelines?: string; task?: string; title?: string; }; tag_count?: number; title_length?: number; tone?: 'neutral' | 'playful' | 'professional'; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst summarize = await client.robots.jobs.summarize.retrieve('rjob_E6fdcD7d-cDdf-baAa-b31A-1ae5A92d336F');\n\nconsole.log(summarize);\n```",
  },
  {
    name: 'create',
    endpoint: '/robots/v1/jobs/translate-captions',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) robots.jobs.translate-captions > (method) create',
    qualified: 'client.robots.jobs.translateCaptions.create',
    params: [
      'parameters: { asset_id: string; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; };',
      'passthrough?: string;',
    ],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; }[]; outputs?: { temporary_vtt_url?: string; uploaded_track_id?: string; }; parameters?: { asset_ids: string[]; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## create\n\n`client.robots.jobs.translateCaptions.create(parameters: { asset_id: string; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }, passthrough?: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'translate-captions'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**post** `/robots/v1/jobs/translate-captions`\n\nCreates a new job that translates captions on a Mux Video asset from one language to another.\n\n### Parameters\n\n- `parameters: { asset_id: string; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }`\n  - `asset_id: string`\n    The Mux asset ID of the video whose captions will be translated.\n  - `from_language_code: string`\n    ISO 639-1 source language code (e.g. \"en\", \"fr\").\n  - `to_language_code: string`\n    ISO 639-1 target language code (e.g. \"es\", \"ja\").\n  - `upload_to_mux?: boolean`\n    Whether to upload the translated VTT and attach it as a text track on the Mux asset. Defaults to true.\n\n- `passthrough?: string`\n  Arbitrary string stored with the job and returned in responses. Useful for correlating jobs with your own systems.\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; }[]; outputs?: { temporary_vtt_url?: string; uploaded_track_id?: string; }; parameters?: { asset_ids: string[]; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'translate-captions'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { temporary_vtt_url?: string; uploaded_track_id?: string; }`\n  - `parameters?: { asset_ids: string[]; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst translateCaption = await client.robots.jobs.translateCaptions.create({ parameters: {\n  asset_id: 'mux_asset_123abc',\n  from_language_code: 'en',\n  to_language_code: 'es',\n} });\n\nconsole.log(translateCaption);\n```",
  },
  {
    name: 'retrieve',
    endpoint: '/robots/v1/jobs/translate-captions/{JOB_ID}',
    httpMethod: 'get',
    summary: "Get a 'translate-captions' job",
    description: "Retrieves the current status and results of a 'translate-captions' job.",
    stainlessPath: '(resource) robots.jobs.translate-captions > (method) retrieve',
    qualified: 'client.robots.jobs.translateCaptions.retrieve',
    params: ['JOB_ID: string;'],
    response:
      "{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; }[]; outputs?: { temporary_vtt_url?: string; uploaded_track_id?: string; }; parameters?: { asset_ids: string[]; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }",
    markdown:
      "## retrieve\n\n`client.robots.jobs.translateCaptions.retrieve(JOB_ID: string): { id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'translate-captions'; errors?: object[]; outputs?: object; parameters?: object; passthrough?: string; resources?: object; usage?: object; }`\n\n**get** `/robots/v1/jobs/translate-captions/{JOB_ID}`\n\nRetrieves the current status and results of a 'translate-captions' job.\n\n### Parameters\n\n- `JOB_ID: string`\n\n### Returns\n\n- `{ id: string; created_at: number; status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'; updated_at: number; workflow: 'translate-captions'; errors?: { message: string; type: string; }[]; outputs?: { temporary_vtt_url?: string; uploaded_track_id?: string; }; parameters?: { asset_ids: string[]; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }; passthrough?: string; resources?: { assets: { id: string; _links: object; meta?: object; passthrough?: string; }[]; }; usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }; }`\n\n  - `id: string`\n  - `created_at: number`\n  - `status: 'pending' | 'processing' | 'completed' | 'errored' | 'cancelled'`\n  - `updated_at: number`\n  - `workflow: 'translate-captions'`\n  - `errors?: { message: string; type: string; }[]`\n  - `outputs?: { temporary_vtt_url?: string; uploaded_track_id?: string; }`\n  - `parameters?: { asset_ids: string[]; from_language_code: string; to_language_code: string; upload_to_mux?: boolean; }`\n  - `passthrough?: string`\n  - `resources?: { assets: { id: string; _links: { self: { href: string; }; }; meta?: { creator_id?: string; external_id?: string; title?: string; }; passthrough?: string; }[]; }`\n  - `usage?: { cached_input_tokens?: number; input_tokens?: number; output_tokens?: number; reasoning_tokens?: number; total_tokens?: number; }`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst translateCaption = await client.robots.jobs.translateCaptions.retrieve('rjob_E6fdcD7d-cDdf-baAa-b31A-1ae5A92d336F');\n\nconsole.log(translateCaption);\n```",
  },
  {
    name: 'list',
    endpoint: '/robots/v1/workflows',
    httpMethod: 'get',
    summary: 'List workflows',
    description: 'List all available workflows',
    stainlessPath: '(resource) robots.workflows > (method) list',
    qualified: 'client.robots.workflows.list',
    response:
      "{ id: string; _links: { create_job: { href: string; method: 'POST'; }; get_job: { href: string; method: 'GET'; }; }; description: string; tags: string[]; title: string; type: 'prebuilt'; }[]",
    markdown:
      "## list\n\n`client.robots.workflows.list(): { id: string; _links: object; description: string; tags: string[]; title: string; type: 'prebuilt'; }[]`\n\n**get** `/robots/v1/workflows`\n\nList all available workflows\n\n### Returns\n\n- `{ id: string; _links: { create_job: { href: string; method: 'POST'; }; get_job: { href: string; method: 'GET'; }; }; description: string; tags: string[]; title: string; type: 'prebuilt'; }[]`\n\n### Example\n\n```typescript\nimport Mux from '@mux/mux-node';\n\nconst client = new Mux();\n\nconst workflows = await client.robots.workflows.list();\n\nconsole.log(workflows);\n```",
  },
  {
    name: 'list',
