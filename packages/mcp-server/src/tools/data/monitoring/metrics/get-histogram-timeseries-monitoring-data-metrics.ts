...
export const tool: Tool = {
  ...
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nGets histogram timeseries information for a specific metric.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/metric_get_histogram_timeseries_response',\n  $defs: {\n    metric_get_histogram_timeseries_response: {\n      type: 'object',\n      properties: {\n        data: {\n          type: 'array',\n          items: {\n            type: 'object',\n            properties: {\n              average: {\n                type: 'number'\n              },\n              bucket_values: {\n                type: 'array',\n                items: {\n                  type: 'object',\n                  properties: {\n                    count: {\n                      type: 'integer'\n                    },\n                    percentage: {\n                      type: 'number'\n                    }\n                  },\n                  required: [                    'count',\n                    'percentage'\n                  ]\n                }\n              },\n              max_percentage: {\n                type: 'number'\n              },\n              median: {\n                type: 'number'\n              },\n              p95: {\n                type: 'number'\n              },\n              sum: {\n                type: 'integer'\n              },\n              timestamp: {\n                type: 'string'\n              }\n            },\n            required: [              'average',\n              'bucket_values',\n              'max_percentage',\n              'median',\n              'p95',\n              'sum',\n              'timestamp'\n            ]\n          }\n        },\n        meta: {\n          type: 'object',\n          properties: {\n            bucket_unit: {\n              type: 'string'\n            },\n            buckets: {\n              type: 'array',\n              items: {\n                type: 'object',\n                properties: {\n                  end: {\n                    type: 'integer'\n                  },\n                  start: {\n                    type: 'integer'\n                  }\n                },\n                required: [                  'end',\n                  'start'\n                ]\n              }\n            }\n          },\n          required: [            'bucket_unit',\n            'buckets'\n          ]\n        },\n        timeframe: {\n          type: 'array',\n          items: {\n            type: 'integer'\n          }\n        },\n        total_row_count: {\n          type: 'integer'\n        }\n      },\n      required: [        'data',\n        'meta',\n        'timeframe',\n        'total_row_count'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
    ...
    required: ['MONITORING_HISTOGRAM_METRIC_ID'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: Mux, args: Record<string, unknown> | undefined) => {
  const { MONITORING_HISTOGRAM_METRIC_ID, jq_filter, ...body } = args as any;
  return asTextContentResult(
    await maybeFilter(
      jq_filter,
      await client.data.monitoring.metrics.getHistogramTimeseries(MONITORING_HISTOGRAM_METRIC_ID, body),
    ),
  );
};
