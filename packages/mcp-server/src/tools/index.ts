...
import animated_video_playback from './video/playback/animated-video-playback';
import hls_video_playback from './video/playback/hls-video-playback';
import static_rendition_video_playback from './video/playback/static-rendition-video-playback';
import storyboard_video_playback from './video/playback/storyboard-video-playback';
import storyboard_meta_video_playback from './video/playback/storyboard-meta-video-playback';
import storyboard_vtt_video_playback from './video/playback/storyboard-vtt-video-playback';
import thumbnail_video_playback from './video/playback/thumbnail-video-playback';
...
addEndpoint(animated_video_playback);
addEndpoint(hls_video_playback);
addEndpoint(static_rendition_video_playback);
addEndpoint(storyboard_video_playback);
addEndpoint(storyboard_meta_video_playback);
addEndpoint(storyboard_vtt_video_playback);
addEndpoint(thumbnail_video_playback);
