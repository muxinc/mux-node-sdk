...
export const sdkMethods: SdkMethod[] = [{
  ...
  clientCallName: 'client.robotsPreview.jobs.list',
  fullyQualifiedName: 'robotsPreview.jobs.list',
  httpMethod: 'get',
  httpPath: '/robots/v0/jobs',
},{
  clientCallName: 'client.robotsPreview.jobs.cancel',
  fullyQualifiedName: 'robotsPreview.jobs.cancel',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/{JOB_ID}/cancel',
},{
  clientCallName: 'client.robotsPreview.jobs.askQuestions.create',
  fullyQualifiedName: 'robotsPreview.jobs.askQuestions.create',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/ask-questions',
},{
  clientCallName: 'client.robotsPreview.jobs.askQuestions.retrieve',
  fullyQualifiedName: 'robotsPreview.jobs.askQuestions.retrieve',
  httpMethod: 'get',
  httpPath: '/robots/v0/jobs/ask-questions/{JOB_ID}',
},{
  clientCallName: 'client.robotsPreview.jobs.generateChapters.create',
  fullyQualifiedName: 'robotsPreview.jobs.generateChapters.create',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/generate-chapters',
},{
  clientCallName: 'client.robotsPreview.jobs.generateChapters.retrieve',
  fullyQualifiedName: 'robotsPreview.jobs.generateChapters.retrieve',
  httpMethod: 'get',
  httpPath: '/robots/v0/jobs/generate-chapters/{JOB_ID}',
},{
  clientCallName: 'client.robotsPreview.jobs.findKeyMoments.create',
  fullyQualifiedName: 'robotsPreview.jobs.findKeyMoments.create',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/find-key-moments',
},{
  clientCallName: 'client.robotsPreview.jobs.findKeyMoments.retrieve',
  fullyQualifiedName: 'robotsPreview.jobs.findKeyMoments.retrieve',
  httpMethod: 'get',
  httpPath: '/robots/v0/jobs/find-key-moments/{JOB_ID}',
},{
  clientCallName: 'client.robotsPreview.jobs.moderate.create',
  fullyQualifiedName: 'robotsPreview.jobs.moderate.create',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/moderate',
},{
  clientCallName: 'client.robotsPreview.jobs.moderate.retrieve',
  fullyQualifiedName: 'robotsPreview.jobs.moderate.retrieve',
  httpMethod: 'get',
  httpPath: '/robots/v0/jobs/moderate/{JOB_ID}',
},{
  clientCallName: 'client.robotsPreview.jobs.summarize.create',
  fullyQualifiedName: 'robotsPreview.jobs.summarize.create',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/summarize',
},{
  clientCallName: 'client.robotsPreview.jobs.summarize.retrieve',
  fullyQualifiedName: 'robotsPreview.jobs.summarize.retrieve',
  httpMethod: 'get',
  httpPath: '/robots/v0/jobs/summarize/{JOB_ID}',
},{
  clientCallName: 'client.robotsPreview.jobs.translateCaptions.create',
  fullyQualifiedName: 'robotsPreview.jobs.translateCaptions.create',
  httpMethod: 'post',
  httpPath: '/robots/v0/jobs/translate-captions',
},{
  clientCallName: 'client.robotsPreview.jobs.translateCaptions.retrieve',
  fullyQualifiedName: 'robotsPreview.jobs.translateCaptions.retrieve',
  httpMethod: 'get',
