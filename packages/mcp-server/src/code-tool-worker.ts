...
const fuse = new Fuse(
  [
    ...
    'client.robotsPreview.jobs.cancel',
    'client.robotsPreview.jobs.list',
    'client.robotsPreview.jobs.askQuestions.create',
    'client.robotsPreview.jobs.askQuestions.retrieve',
    'client.robotsPreview.jobs.generateChapters.create',
    'client.robotsPreview.jobs.generateChapters.retrieve',
    'client.robotsPreview.jobs.findKeyMoments.create',
    'client.robotsPreview.jobs.findKeyMoments.retrieve',
    'client.robotsPreview.jobs.moderate.create',
    'client.robotsPreview.jobs.moderate.retrieve',
    'client.robotsPreview.jobs.summarize.create',
    'client.robotsPreview.jobs.summarize.retrieve',
    'client.robotsPreview.jobs.translateCaptions.create',
    'client.robotsPreview.jobs.translateCaptions.retrieve',
